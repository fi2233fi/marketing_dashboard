# Marketing & Business Insights Dashboard

Power BI dashboard analyzing customer purchasing behavior, campaign 
performance, and sales channel trends across 1,999 transactions.
...
|--------|---------|
| Total Revenue | $20K |
| Total Purchases | 1,999 |
| Average Order Value | $9.22 |
| Average Customer Tenure | 4,200 days |
| Peak Revenue Month | January 2013 ($3.1K) |

**Revenue is highly seasonal with sharp drop-offs**
...
Several months show zero conversion entirely, which points to gaps 
in campaign coverage or channel misalignment rather than a product 
or pricing issue.

**Customer tenure is strong but flat**
...
See `businessinsightsdashboard.pdf` for full visuals.

Filters included for age group, income group, marketing campaign, 
sales channel, year, and month.

---

## Files

- `businessinsightsdashboard.pdf` — dashboard export
- `Re-Cleaned_Marketing_Data.xlsx` — cleaned dataset
